            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Add New Social</h4>
                    ...
                    @endif
                    <div class="card-body">
                        <form name="addNewsfrm" enctype="multipart/form-data" action="{{ route('admin-social-store') }}" method="POST">
                            @csrf
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div>
                                            ...
                                            <select class="form-select select2" id="topic" name="topic">
                                                ...
                                                <option value="{{ $value->id }}" @if(old('topic') == $value->id) selected @endif> {{ $value->topic }} </option>
                                                @endforeach
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div>
                                            ...
                                            <textarea class="form-control" id="myeditor" name="long_description" rows="20">{{old('long_description')}}</textarea>
