                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="addNewsfrm" enctype="multipart/form-data"
                                action="{{ route('admin-category-update', Crypt::encrypt($data->id)) }}" method="POST">
                                @csrf
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div>
                                                ...
                                                <input type="number" class="form-control"  id="priority" value="{{$data->category_priority}}" name="priority">
                                            </div>
