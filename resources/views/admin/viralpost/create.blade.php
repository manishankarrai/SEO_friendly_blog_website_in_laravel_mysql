                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Add ViralBlogs</li>
                            </ol>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Add New ViralBlogs</h4>
                        ...
                        <div class="card-body">
                            <form name="addNewsfrm" enctype="multipart/form-data"
                                action="{{ route('admin-viralblog-store') }}" method="POST">
                                @csrf
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div>
                                                ...
                                                <textarea class="form-control" id="link" name="link" rows="2">{{ old('link') }}</textarea>
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div>
                                                ...
                                                <textarea class="form-control" id="sort_description" name="sort_description" rows="2">{{ old('sort_description') }}</textarea>
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div>
                                                ...
                                                <textarea class="form-control" id="long_description" name="long_description" rows="6">{{ old('long_description') }}</textarea>
